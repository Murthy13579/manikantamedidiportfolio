      ...
      >
        ...
        >
          <div className="bg-white/80 backdrop-blur p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-700">Engineered distributed systems in Java 17 / Spring Boot 3 with Kafka, achieving sub-second latency and scalable event streaming.</p>
          </div>

          <div className="bg-white/80 backdrop-blur p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-blue-600 font-bold text-lg mb-3">Cloud & DevOps</h3>
            <p className="text-gray-700">Deployed resilient services on AWS & Azure using Terraform and CI/CD, reducing release cycles by 40%.</p>
          </div>

          <div className="bg-white/80 backdrop-blur p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-blue-600 font-bold text-lg mb-3">Frontend Innovation</h3>
            <p className="text-gray-700">Delivered responsive, data-driven dashboards using React & Angular, enabling real-time enterprise visualization.</p>
          </div>

          <div className="bg-white/80 backdrop-blur p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-blue-600 font-bold text-lg mb-3">Modern AI Integration</h3>
            <p className="text-gray-700">Enhanced Java applications with LLMs & LangChain4j integration to provide intelligent data processing and automated analytics capabilities.</p>
          </div>
        </motion.div>
